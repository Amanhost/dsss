...
const SanctionAmount = ({
  ...
  disableHandleCm,
  handleCMbutton,
  handleButtonOdApprove,
  actionButtonNameODCalling,
  disableactionButtonNameOD,
  isOTCmodalopen
  ...
  return (
    <Modal
      ...
      autoFocus={true}
      restoreFocus={true}
      className={isOTCmodalopen ? "modal-blur" : "modalContent"}
        ...
        <div className="d-flex flex-row gap-1 justify-content-between" >
          ...
          <div>
            ...
            {handleButtonOdApprove && (
              <button
                className="btn btn-primary fw-bold  rounded-5 border-2 "
                onClick={handleButtonOdApprove}
                disabled={disableactionButtonNameOD}
              >
                {actionButtonNameODCalling}
              </button>
            )}
